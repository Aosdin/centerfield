...
export default {
  ...
  mounted() {
    ...
    this.ScrollTrigger01 = ScrollTrigger.create({
      trigger: '#i2',
      start: 'top ' + (`${window.screen.height}` - 520) + 'px',
      // markers: true,
      end: 'top top+=' + (`${window.screen.height}` - this.vtop - 380),
      scrub: true,
      pin: true,
      overwrite: true,
    ...
    this.ScrollTrigger02 = ScrollTrigger.create({
      ...
      start: 'top ' + (`${window.screen.height}` - 520) + 'px',
      // markers: true,
      end: 'top top+=' + (`${window.screen.height}` - this.vtop - 640),
      scrub: true,
      pin: true,
      overwrite: true,
    ...
    this.ScrollTrigger03 = ScrollTrigger.create({
      ...
      start: 'top ' + (`${window.screen.height}` - 520) + 'px',
      // markers: true
      end: 'top top+=' + (`${window.screen.height}` - this.vtop - 900),
      scrub: true,
      pin: true,
      overwrite: true,
