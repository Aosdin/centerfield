        ...
        <ul class="mypage-list">
          <li class="grid-2">
            <div class="item">
              ...
              <a href="#" class="btn2 btg-primary">더보기</a>
            </div>
          </li>
          <li class="grid-2">
            <div class="item">
          ...
          <li>
            <div class="item">
              <h4 class="taleft">신세계포인트</h4>
              <div class="item-area">
                <div class="item-tit taleft"><span class="ftc-primary">2,003</span></div>
              </div>
              <div class="barcode"><img src="../assets/images/temp/barcode.png" alt="" /></div>
          ...
          <li>
            <div class="item">
              ...
              <a href="#" class="btn2 btg-primary">개인정보수정</a>
