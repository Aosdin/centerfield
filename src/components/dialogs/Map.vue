<template>
  <v-dialog
    ...
    hide-overlay
    persistent
    content-class="pop-modal-survey"
  ...
  >
    ...
    >
      <div class="pop-header">
        <h5>경로찾기</h5>
        <button @click="setMapDialogsAction(false)">닫기</button>
      </div>
      <div class="contents">
        <div>
          <div>
            <button @click="fromFloor = 'parking'">주차장</button>
            <button @click="fromFloor = 'B2'">B2</button>
            <button @click="fromFloor = 'B1'">B1</button>
            <button @click="fromFloor = 'F1'">F1</button>
            <button @click="fromFloor = 'F2'">F2</button>
          </div>
          <div>
            <select v-model="fromSel">
        ...
        <div>
          <div>
            <button @click="toFloor = 'parking'">주차장</button>
            <button @click="toFloor = 'B2'">B2</button>
            <button @click="toFloor = 'B1'">B1</button>
            <button @click="toFloor = 'F1'">F1</button>
            <button @click="toFloor = 'F2'">F2</button>
          </div>
          <div>
            <select v-model="toSel">
              <option value="">선택하세요.</option>
